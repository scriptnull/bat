...
var testSuiteNum = '2.';
var testSuiteDesc = 'Individual-Owner-github-getProjects';
...
describe(testSuite,
  function () {
    ...
    it('Individual-Owner-github-getProjects',
      function (done) {
        this.timeout(0);
        var shippable = new Shippable(config.apiToken);
        var query = util.format("subscriptionIds=%s",nconf.get("shiptest-github-owner:owner-subId-gh"));
