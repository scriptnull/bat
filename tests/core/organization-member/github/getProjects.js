...
var testSuiteNum = '4.';
var testSuiteDesc = 'Organization-Member-github-getProjects';
...
describe(testSuite,
  function () {
    ...
    it('Organization-Member-github-getProjects',
      function (done) {
        this.timeout(0);
        var shippable = new Shippable(config.apiToken);
        var query = util.format("subscriptionIds=%s",nconf.get("shiptest-github-member:org-m-subId-gh"));
