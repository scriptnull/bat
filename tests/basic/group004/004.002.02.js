...
describe('Test 004.002.02: Run a matrix build with Github private scope',
  function() {
  ...
  before(function(done) {
    this.timeout(0);
    thisAccount =  nconf.get('testAccounts:shipayeone');
  ...
  it('can run a matrix build', function(done) {
    this.timeout(0);
    ...
    if (!someProject) {
      return done(new Error(myUserName + '/' +
        myProject + ' not found.'));
    }
