...
var logger = bunyan.createLogger({ name: '99.1.6: Delete shipaye6 account'});
var assert = require('assert');
var async = require('async');
var Shippable = require('../../../lib/shippable/shippable.js');

describe('99.1.6: Delete shipaye6 account',
  function() {
  ...
  it('Should delete shipaye6', function(done) {
    var shipaye6 = nconf.get('testAccounts:shipaye6');
    var id;
    var shipayeoneAccount;

    var shippable = new Shippable(nconf.get('apiEndpoint'), shipaye6.apiToken);
