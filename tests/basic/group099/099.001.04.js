...
var logger = bunyan.createLogger({ name: '99.1.4: Delete shipaye4 account'});
var assert = require('assert');
var async = require('async');
var Shippable = require('../../../lib/shippable/shippable.js');

describe('99.1.4: Delete shipaye4 account',
  function() {
  ...
  it('Should delete shipaye4', function(done) {
    var shipaye4 = nconf.get('testAccounts:shipaye4');
    var id;
    var shipayeoneAccount;

    var shippable = new Shippable(nconf.get('apiEndpoint'), shipaye4.apiToken);
