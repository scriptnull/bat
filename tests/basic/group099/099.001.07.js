...
var logger = bunyan.createLogger({ name: '99.1.7: All accounts are deleted from the testAccounts nconf object'});
var chai = require('chai');
var assert = chai.assert;

describe('99.1.7: All accounts are deleted from the testAccounts nconf object', function() {
