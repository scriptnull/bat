...
var logger = bunyan.createLogger({ name: '1.1.2: Create an account via token exchange for shipaye2'});
var chai = require('chai');
var chaihttp = require('chai-http');
chai.use(chaihttp);
var assert = chai.assert;

describe('1.1.2: Creating Accounts via Token Exchange', function() {
