...
var mocha = require('mocha'),
    ...
    logger = bunyan.createLogger({ name: 'TestCase 3.10.1: Enable Project ' +
     'in Org Owned by Public GitHub User' });

describe('Test Case 3.10.1: Using Github Public token:', function () {
  var shippable = null;
  this.timeout(0);
  ...
  it('Enable org project as an owner', function (done) {
    logger.info('Enabling PublicOrg/sample_ubuntu1204_java as shipaye2');
