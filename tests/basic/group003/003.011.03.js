...
var mocha = require('mocha'),
    ...
    logger = bunyan.createLogger({ name: 'TestCase 3.11.3: Enable Project ' +
     'as a Bitbucket Team Collaborator' });

describe('Test Case 3.11.3: Using Bitbucket token:', function () {
  var shippable = null;
  ...
  it('Enable org project as a collaborator', function (done) {
    logger.info('Enabling PublicOrg/sample_node_neo4j as shipaye6');
    ...
    function getProjectId(next) {
      shippable.getAllProjects(function (err, projects) {
        ...
        projects.some(function (project) {
          if (project.fullName === 'PublicOrg/sample_node_neo4j') {
