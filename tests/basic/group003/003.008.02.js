...
var mocha = require('mocha'),
    ...
    logger = bunyan.createLogger({ name: 'TestCase 3.8.2: Enable Project ' +
     'Belonging to Private GitHub User' });

describe('Test Case 3.8.2: Using Github Private token:', function () {
  var shippable = null;
  this.timeout(0);
  ...
  it('Enable project', function (done) {
    logger.info('Enabling shipayeone/samplePython as shipayeone');
    ...
    function getProjectId(next) {
      shippable.getAllProjects(function (err, projects) {
        ...
        projects.some(function (project) {
          if (project.fullName === 'shipayeone/samplePython') {
