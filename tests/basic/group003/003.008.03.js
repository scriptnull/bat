...
var mocha = require('mocha'),
    ...
    logger = bunyan.createLogger({ name: 'TestCase 3.8.3: Enable Project ' +
     'Belonging to Bitbucket User' });

describe('Test Case 3.8.3: Using Bitbucket token:', function () {
  var shippable = null;
  this.timeout(0);
  ...
  it('Enable project', function (done) {
    logger.info('Enabling shipayefive/sample_php as shipayefive');
    ...
    function getProjectId(next) {
      shippable.getAllProjects(function (err, projects) {
        ...
        projects.some(function (project) {
          if (project.fullName === 'shipayefive/sample_php') {
